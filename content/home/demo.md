...
{{< callout note >}}
This homepage section is an example of adding [elements](https://docs.hugoblox.com/reference/markdown/) to the [*Blank* widget](https://docs.hugoblox.com/reference/blocks/).
